...
Version 0.1.4 supports exactly the following two languages. The browser demo and Obsidian settings display this complete list; the plugin does not claim universal language support.
