...
The product keeps the compact IntelliJ New UI-inspired editor and tool-window hierarchy established by the 0.1 series. Version 0.2.4 applies that same component to the complete 21-language catalog and makes the active execution boundary visible.
